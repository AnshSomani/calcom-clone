    ...
    <div className="p-8 max-w-4xl mx-auto fade-in">
      ...
      {loading ? (
        ...
        <div className="space-y-2.5">
          {eventTypes.map(et => (
            <div key={et.id}
              className={`bg-[#181818] rounded-xl border border-neutral-800/80 flex items-center overflow-hidden shadow-sm hover:shadow-md transition-all fade-in-up ${!et.is_active ? 'opacity-50' : ''}`}>
              {/* Color bar */}
              ...
              <div className="flex-1 px-5 py-4 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1 flex-wrap">
                  ...
                  {(et.question_count || 0) > 0 && (
                    <span className="text-xs text-neutral-400">{et.question_count} question{et.question_count !== 1 ? 's' : ''}</span>
                  )}
                  {(et.buffer_after || 0) > 0 && (
                    <span className="text-xs text-neutral-400">+{et.buffer_after}min buffer</span>
                  )}
                </div>
                <div className="text-xs text-amber-500/80 mt-1 font-mono">/{et.username}/{et.slug}</div>
              </div>
              ...
              <div className="flex items-center gap-1 pr-4">
                ...
                <button onClick={() => setDeleteConfirm(et)} title="Delete"
                  className="p-2 hover:bg-red-950/20 rounded-lg transition-colors text-neutral-400 hover:text-red-400">
