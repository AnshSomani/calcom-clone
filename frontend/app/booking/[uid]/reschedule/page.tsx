  ...
  if (booking.status === 'cancelled') return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-10 max-w-sm w-full text-center">
        ...
        <h2 className="text-xl font-bold text-slate-900 mb-2">Cannot Reschedule</h2>
        <p className="text-slate-500 text-sm mt-2">This booking has been cancelled.</p>
      </div>
    </div>
  );
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 h-fit">
            ...
            <div className="text-sm text-slate-500 font-medium mb-1">{booking.host_name}</div>
            <h1 className="text-2xl font-bold mb-4" style={{ color: booking.color }}>{booking.event_type_title}</h1>

            {/* Current booking warning box */}
            <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-xl">
              <div className="text-xs font-semibold text-amber-800 mb-1">Current Booking</div>
              <div className="text-[13px] text-amber-900">{formatDate(booking.start_time)}</div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            <h2 className="text-lg font-bold text-slate-900 mb-6">Reschedule — Pick a New Time</h2>
