              ...
              <>
                ...
                {slotsLoading ? (
                  ...
                  <>
                    ...
                    {selectedSlot && (
                      <button
                        className="w-full py-3.5 bg-white hover:bg-neutral-200 text-black font-semibold rounded-xl transition-colors disabled:opacity-60 flex items-center justify-center"
